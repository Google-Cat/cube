...
public class Figure3 extends Shape {
    ...
    boolean isAnyThingUnderFigure(Memory memory) {
        ...
        switch (k % 4) {
            ...
            case 2:
                if (memory.getMatrix()[x4 / CUBESIZE][y4 / CUBESIZE + 1] == true || memory.getMatrix()[x2 / CUBESIZE][y2 / CUBESIZE + 1] == true || memory.getMatrix()[x1 / CUBESIZE][y1 / CUBESIZE + 1] == true) {
                    bln = true;
                    break;
                }
            case 3:
            ...
            case 0:
                if (memory.getMatrix()[x1 / CUBESIZE][y1 / CUBESIZE + 1] == true || memory.getMatrix()[x2 / CUBESIZE][y2 / CUBESIZE + 1] == true || memory.getMatrix()[x3 / CUBESIZE][y3 / CUBESIZE + 1] == true) {
